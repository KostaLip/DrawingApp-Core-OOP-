...
public class FrameStack extends JFrame {
	...
	public FrameStack() {
		...
		glPnlCenter.setVerticalGroup(
			glPnlCenter.createParallelGroup(Alignment.TRAILING)
				.addGroup(Alignment.LEADING, glPnlCenter.createSequentialGroup()
					.addContainerGap()
		...
		glPnlSouth.setHorizontalGroup(
			glPnlSouth.createParallelGroup(Alignment.LEADING)
				.addGroup(glPnlSouth.createSequentialGroup()
					.addGap(48)
					.addComponent(addBtn)
		...
		glPnlSouth.setVerticalGroup(
			glPnlSouth.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, glPnlSouth.createSequentialGroup()
					.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
					.addGroup(glPnlSouth.createParallelGroup(Alignment.BASELINE)
						.addComponent(addBtn)
						.addComponent(deleteBtn)))
		);
